...
public:
    ...
    float shininess;
    // ctor/dtor
    Sphere(float radius = 1.0f, int sectorCount = 36, int stackCount = 18, glm::vec3 amb = glm::vec3(1.0f, 0.0f, 0.0f), glm::vec3 diff = glm::vec3(1.0f, 0.0f, 0.0f), glm::vec3 spec = glm::vec3(0.5f, 0.5f, 0.5f), glm::vec3 emi = glm::vec3(0.0f, 0.0f, 1.0f), float shiny = 32.0f) : verticesStride(24)
    {
        set(radius, sectorCount, stackCount, amb, diff, spec,emi ,shiny);
    ...
    void set(float radius, int sectors, int stacks, glm::vec3 amb, glm::vec3 diff, glm::vec3 spec, glm::vec3 emi, float shiny)
    {
        if (radius > 0)
            this->radius = radius;
    ...
    void setRadius(float radius)
    {
        if (radius != this->radius)
            set(radius, sectorCount, stackCount, ambient, diffuse, specular, emission,shininess);
    }
    ...
    void drawSphere(Shader& lightingShader, glm::mat4 model) const      // draw surface
    {
        ...
        lightingShader.setVec3("material.specular", this->emission);
